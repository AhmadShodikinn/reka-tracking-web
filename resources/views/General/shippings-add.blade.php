                    ...
                    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                      <div x-data="{ totalBarang: 1, forms: [{ itemCode: '', quantitySend: '', unitType: '', description: '', totalSend: '', information: '', qtyPreOrder:'' }] }" class="py-6">
                        ...
                        <div class="justify-end flex space-x-4">
                          <button type="button" @click="if (forms.length < 10) { forms.push({ itemCode: '', quantitySend: '', unitType: '', description: '', totalSend: '', information: '', qtyPreOrder:'' }); totalBarang++ }" :class="forms.length >= 10 ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-400'" :disabled="forms.length >= 10" class="rounded-md text-white px-3.5 py-2.5 text-sm font-semibold shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                            Tambah Item
                          </button>
